...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Make a fake tree of documents with for your test suite'
  spec.description   = 'FakeTree utilizes FakeFS to create a fake tree of \
  documents for your tests.'
